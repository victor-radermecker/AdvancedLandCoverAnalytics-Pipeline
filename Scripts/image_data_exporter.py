...
FISHNET_PATH = "/home/ubuntu/avapsi/conv-lstm/Capstone_JPMorgan/Data/fishnet_filtered.pkl"
FILTER = False
SAVE_DIR = '/home/ubuntu/avapsi/conv-lstm/Capstone_JPMorgan/Data/Exports'
...
i = 11
df_which = 'other' #sah, dfw, desert, other
year_to_run = 2019 #2016 2017, 2018, 2019
...
if df_which == 'dfw':
    ...
    df.to_pickle('/home/ubuntu/avapsi/conv-lstm/Capstone_JPMorgan/Data/fishnet_filtered_dwf_{}.pkl'.format(i))
    ...
    df.to_pickle('/home/ubuntu/avapsi/conv-lstm/Capstone_JPMorgan/Data/fishnet_filtered_sah_{}.pkl'.format(i))
    ...
    df.to_pickle('/home/ubuntu/avapsi/conv-lstm/Capstone_JPMorgan/Data/fishnet_filtered_desert_{}.pkl'.format(i))
